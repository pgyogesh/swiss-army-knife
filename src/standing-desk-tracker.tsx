...
export default function Command() {
  ...
  const [todayStats, setTodayStats] = useState<{ standing: number; sitting: number } | null>(null);
    ...
    return (
      <List>
        ...
        <List.Item
          ...
          actions={
            <ActionPanel>
              <Action title="Start Standing" onAction={() => handleToggleState("standing")} />
            </ActionPanel>
          }
        />
        <List.Item
          ...
          actions={
            <ActionPanel>
              <Action title="Start Sitting" onAction={() => handleToggleState("sitting")} />
            </ActionPanel>
          }
        />
      </List>
  ...
  const nextState: DeskState = currentState === "standing" ? "sitting" : "standing";
    ...
    <List>
      <List.Section title="Current Status">
        <List.Item
          ...
          icon={{ source: getStateIcon(currentState), tintColor: getStateColor(currentState) }}
          actions={
            <ActionPanel>
              <Action
